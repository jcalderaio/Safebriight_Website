...
export default StyleSheet.create({
    ...
    "silvertext": {
        ...
        "OTransition": "color 0.2s ease",
        "transition": "color 0.2s ease",
        "position": "relative",
        "fontSize": 50,
        "fontWeight": "bold",
        "color": "#DEDEDE",
        "textShadow": "0px 1px 0px #ABABAB,                     0px 2px 3px #828282,                     0px 3px 0px #4F4F4F,                     0px 4px 0px #4F4F4F,                     0px 5px 0px #4F4F4F,                     0px 6px 1px rgba(0,0,0,0.7),                     0px 10px 5px rgba(0,0,0,0.5)"
    },
    "silvertext:after": {
        "color": "rgba(255,255,255,0.0)",
        "textShadow": "0px -2px 2px rgba(255,255,255,0.6)",
        "position": "absolute",
        "right": 0
    },
    "silvertext:hover": {
